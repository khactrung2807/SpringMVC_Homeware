...
<c:url value = "/view/client/assets" var="url"/>
  ...
  <section id="aa-product-category">
    <div class="container">
      <div class="row">
      	<div>
      		<h1 style ="text-align: center; color: red;">TAH Homeware</h1>
      		<p>Chúng tôi hi vọng tất cả người tiêu dùng Việt nam sẽ được sử dụng những thụ phẩm công nghệ chất lượng, uy tín và an toàn nhất tại cửa hàng cung
      		 cấp thực phẩm rau củ sạch <strong>TAH Homeware</strong>.Với sứ mệnh trở thành một trong những nhà cung cấp thực phẩm sạch hàng đầu tại
      		 Việt Nam đưa đến người tiêu dùng loại nông sản tươi ngon nhất của các vùng miền trên toàn quốc với mục đích là 
      		<strong>“Mang thiên nhiên về với căn nhà của bạn”</strong>. Với quy trình lựa chọn và kiểm soát nghiêm ngặt TAH Homeware đã tạo nên quỹ đầu tư chuyên thu mua 
      		...
      		nhất trong từng sản phẩm khác biệt từ thiên nhiên.</p>
                <img src="${url}/images/5-min.jpg" alt="Thực phẩm sạch" width="1160px"/> <br/> <br>
      		...
      		chất bảo quản nào bị Bộ Y Tế cấm không được sử dụng và cam kết với quý khách hàng về toàn bộ những sản phẩm được phân phối qua hệ thống phân phối  <strong>TAH Homeware </strong>
      		...
      		<img src="${url}/images/3-min.jpg" alt="Thực phẩm sạch" width= "1160" height= "600"/> <br/> <br>
      		<strong>Dưới đây, chúng tôi xin điểm qua những mặt hàng của TAH Homeware hiện đang được rất nhiều khách hàng tin dùng và ưa chuộng:</strong><br/>
      		<p> <strong>San phẩm công nghệ đến từ TAH Homeware, an toàn có nguồn gốc rõ ràng: </strong>
			Với những loại thiết bị là những loại sản phầm có xuất sứ rõ ràng <strong>TAH Homeware</strong> là địa chỉ uy tín cung cấp cho bạn các loại sản phẩm chất lượng từ các loại  
			...
			các bạn sẽ nhận được thực phẩm tươi nhất với thời gian vận chuyển ngắn nhất đáp ứng được độ tươi ngon đảm bảo vệ sinh, an toàn và ngon miệng.</p>
      		...
      		có chất lượng cao cho gia đình, <strong>TAH Homeware</strong> đang trở nên hoàn thiện hơn để đem đến cho khách hàng không chỉ những sản phẩm Trái cây nhập khẩu,
      		...
      		<p> <strong>Sản phẩm với sự thiết kế đẳng cấp</strong> được khai thác trực tiếp từ rừng già Quảng Ngãi, đem đến cho khách hàng một sản phẩm chất lượng, với giá trị dinh dưỡng cao.</p>
      		<br />
      	</div>
      </div>
     </div>
